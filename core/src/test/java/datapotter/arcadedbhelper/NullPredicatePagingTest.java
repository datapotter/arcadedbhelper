...
import static datapotter.arcadedbhelper.TestPersonDTO_I.$age;
import static datapotter.arcadedbhelper.TestPersonDTO_I.$name;
 ...
 *
 * <p>Run: {@code mvn exec:java -Dexec.mainClass="datapotter.arcadedbhelper.NullPredicatePagingTest"
